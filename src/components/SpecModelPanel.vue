...
<!--
/**
 * SpecModelPanel — slide-in drawer listing all saved Spec Models.
 *
 * Renamed from PlanModelPanel 2026-06-05 r93 — Plan→Spec Phase 2 (Tom verbatim
 * "phase 2 go").  Original PlanModelPanel.vue replaced with a thin re-export
 * shim that imports + re-exports this component for backward-compat with any
 * external/legacy consumer.  Active import site (App.vue) now points at
 * SpecModelPanel directly.
 *
