...
<template>
  <Teleport to="body">
    <!-- BACKDROP REINSTATED 2026-06-03 (Tom: *"no implied close by clicing
         outside the window, THIS IS A UNIVERSAL STANDARD, WHY DID IT NOT GET
         DONE HERE?"*).
         The 2026-05-12 reason for omitting the backdrop — the dark PlanModelBar
         beneath the panel was being click-blocked — is OBSOLETE.  PlanModelBar
         itself was removed 2026-05-12 (the purple Plan Identity Bar replaced
         it), so the backdrop no longer blocks anything important.  Restored
         with click-to-close + Escape support, matching every other modal in
         the app.  Per CLAUDE.md Universal Close-Button Rule. -->
    <div
    ...
    >
      <!-- Header — "Spec Responsibilities" (renamed 2026-05-12 per Tom). The
      ...
      <div class="flex items-center gap-2 px-4 py-2.5 bg-gradient-to-r from-indigo-700 to-violet-600 text-white shrink-0">
        <span class="text-sm font-semibold whitespace-nowrap">Spec Responsibilities</span>
        ...
        <CloseDot
          ...
          :ariaLabel="isDirty ? 'Save and close — data is auto-saved on close' : 'Close Spec Responsibilities'"
          @click="closePanel()"
        />
      </div>
